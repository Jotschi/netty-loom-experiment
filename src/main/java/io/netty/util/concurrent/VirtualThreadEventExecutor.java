 ...
 *
 */
public abstract class VirtualThreadEventExecutor extends AbstractScheduledEventExecutor implements OrderedEventExecutor {
    ...
    private static final AtomicIntegerFieldUpdater<VirtualThreadEventExecutor> STATE_UPDATER =
            AtomicIntegerFieldUpdater.newUpdater(VirtualThreadEventExecutor.class, "state");
    private static final AtomicReferenceFieldUpdater<VirtualThreadEventExecutor, ThreadProperties> PROPERTIES_UPDATER =
            AtomicReferenceFieldUpdater.newUpdater(
            		VirtualThreadEventExecutor.class, ThreadProperties.class, "threadProperties");
    ...
    private final LoomRejectedExecutionHandler rejectedExecutionHandler;
     ...
     *                          executor thread
     */
    protected VirtualThreadEventExecutor(
     ...
     * @param rejectedHandler   the {@link LoomRejectedExecutionHandler} to use.
     */
    protected VirtualThreadEventExecutor(
            EventExecutorGroup parent, ThreadFactory threadFactory,
            boolean addTaskWakesUp, int maxPendingTasks, LoomRejectedExecutionHandler rejectedHandler) {
     ...
     *                          executor thread
     */
    protected VirtualThreadEventExecutor(EventExecutorGroup parent, Executor executor, boolean addTaskWakesUp) {
        this(parent, executor, addTaskWakesUp, DEFAULT_MAX_PENDING_EXECUTOR_TASKS, LoomRejectedExecutionHandlers.reject());
    }
     ...
     * @param rejectedHandler   the {@link LoomRejectedExecutionHandler} to use.
     */
    protected VirtualThreadEventExecutor(EventExecutorGroup parent, Executor executor,
                                        boolean addTaskWakesUp, int maxPendingTasks,
                                        LoomRejectedExecutionHandler rejectedHandler) {
        super(parent);
    ...
    /**
     * Offers the task to the associated {@link LoomRejectedExecutionHandler}.
     *
    ...
    private void doStartThread() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                	VirtualThreadEventExecutor.this.run();
                    success = true;
                } catch (Throwable t) {
                    ...
                    for (;;) {
                        ...
                        if (oldState >= ST_SHUTTING_DOWN || STATE_UPDATER.compareAndSet(
                        		VirtualThreadEventExecutor.this, oldState, ST_SHUTTING_DOWN)) {
                            break;
                        }
                    }
                    ...
                    try {
                        ...
                        for (;;) {
                            ...
                            if (oldState >= ST_SHUTDOWN || STATE_UPDATER.compareAndSet(
                            		VirtualThreadEventExecutor.this, oldState, ST_SHUTDOWN)) {
                                break;
                            }
                        }
                        ...
                        try {
                            ...
                            STATE_UPDATER.set(VirtualThreadEventExecutor.this, ST_TERMINATED);
