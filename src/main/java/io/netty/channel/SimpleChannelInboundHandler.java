 ...
 *
 * For example here is an implementation which only handle {@link String}
 * messages.
 *
 * <pre>
 ...
 * </pre>
 *
 * Be aware that depending of the constructor parameters it will release all
 * handled messages by passing them to
 * {@link ReferenceCountUtil#release(Object)}. In this case you may need to use
 * {@link ReferenceCountUtil#retain(Object)} if you pass the object to the next
 * handler in the {@link ChannelPipeline}.
 */
